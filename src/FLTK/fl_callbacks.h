...
void slider_mixer_primary_device_cb(double);
void slider_mixer_secondary_device_cb(double);
void slider_mixer_streaming_gain_cb(double);
void slider_mixer_recording_gain_cb(double);
void slider_mixer_master_gain_cb(double);
void slider_mixer_cross_fader_cb(double);
